...
class AndroidTestDataProvider {
    ...
    companion object {
        ...
        fun blockData2(): BlockData {
            return BlockData(8752,
                    "004a0d69832c723ecd207d85cfc37be3e1fdd1c68abc4b4d8b6a6565f3d636ad",
                    "2018-06-04T14:22:55.000000Z")
        }
        ...
        fun blockDatas2(): List<BlockData> {
            return object : ArrayList<BlockData>() {
                init {
                    add(blockData1())
                    add(blockData2())
        ...
        fun sqliteConstraintException(): SQLiteConstraintException {
            return SQLiteConstraintException("FOREIGN KEY constraint failed (code 787)")
        }
